    ...
    <Header/>
      ...
      <div className="details flex gap-3 ml-[20px] mb-[200px] ">
        ...
        <div className="c1 w-[950px]">
          ...
          {/* Weekly Menu */}
<div className=" w-[950px] bg-sky-100 text-sky-500 p-[20px] text-[1.1rem] font-mono mb-[15px] rounded-xl overflow-y-auto h-[495px]">
  
  <h2 className="text-[1.4rem] font-semibold mb-[15px] text-center">
    Weekly Menu
  </h2>
...
<div className="room w-[950px] bg-sky-100 text-sky-500 p-[20px] text-[1.1rem] font-mono mb-[10px] rounded-xl">
  ...
  <ul className="list-disc ml-2">
    {pg.roomTypes.map((room, idx) => (
      <li
        key={idx}
        className="grid grid-cols-[170px_30px_1fr] items-start  mb-[10px]"
      >
        {/* Room Type */}
        ...
        {/* Right Column */}
        <div className="c1 w-[450px] ml-[10px] text-sky-500 h-[1000px]">
          {/* Contact */}
          <div className="c1 w-[450px] bg-sky-100 p-[16px] text-[1.6rem] font-mono mb-[20px] h-[180px] rounded-xl">
            <h1 className="mb-[16px]">Contact Number </h1>
          ...
          {/* Current Students */}
          <div className="c1 w-[450px] bg-sky-100 p-[20px] text-[1.6rem] font-mono mb-[20px] h-[510px] rounded-xl">
            <h1 className="mb-[16px]">Current Students</h1>
            {pg.students.map((s, idx) => (
              <div key={idx} className="student flex h-[100px] w-[390px] ml-[10px] mb-[40px] rounded-lg bg-sky-50">
                ...
                <div className="student_details w-[300px] mt-[5px]">
                  ...
                  <div className="student_name w-[300px] h-[30px] flex m-[5px] mt-[10px] text-slate-700">
                    ...
                    <div className="student_name h-[30px] w-[100px] m-[5px] text-slate-700 text-[0.8rem]">{s.semester}</div>
                  </div>
                </div>
              </div>
            ))}
          ...
          {/* Location */}
          <div className="c1 w-[450px] bg-sky-100 p-[20px] text-[1.2rem] font-mono mb-[10px] h-[500px] rounded-xl">
            <h1 className="mb-[16px] text-[1.6rem]">
              <i className="fas fa-location text-sky-500"></i> Location
            </h1>
            <img src={fab_location} className="ml-[20px] w-[380px] h-[380px] bg-slate-400" alt="map" />
          </div>
        </div>
      </div>
    </>
