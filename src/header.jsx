...
<Link to={"/shops"}> 
  ...
  <button  onClick={() => setOpen(true)} className="flex items-center gap-2 px-4 py-2 rounded-lg  text-sky-800 font-semibold  transition-all duration-300 hover:text-white hover:bg-sky-500 hover:shadow-lg">
  ...
  <Link to={"/Login_signup"}> 
      ...
      {/* Extra CSS for animations (Tailwind can't handle all) */}
      <style>{`
        .profile-card {
          display: flex;
          align-items: center;
